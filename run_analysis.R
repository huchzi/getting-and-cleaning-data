...
subject_train <- read.table("~/Coursera Data Science/Getting And Cleaning Data/Course Project/UCI HAR Dataset/train/subject_train.txt", quote="\"", comment.char="")
...
subject_test <- read.table("~/Coursera Data Science/Getting And Cleaning Data/Course Project/UCI HAR Dataset/test/subject_test.txt", quote="\"", comment.char="")
